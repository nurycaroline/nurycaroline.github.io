...
})(["width:100%;display:flex;align-items:center;overflow-x:auto;padding:0 20px 20px 0;::-webkit-scrollbar-track{-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.3);border-radius:10px;background-color:", ";height:5px;}::-webkit-scrollbar{width:12px;height:5px;background-color:", ";}::-webkit-scrollbar-thumb{background-color:", ";border-radius:10px;height:5px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.3);}"], function (_ref3) {
...
//# sourceMappingURL=index.js.2eba2ea3754ec970de02.hot-update.js.map