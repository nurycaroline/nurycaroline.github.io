...
})(["background:#fbfbfb;box-shadow:0px 4px 4px rgba(0,0,0,0.25);border-radius:24px;width:410px;height:210px;display:flex;align-items:center;padding:20px;margin:20px;div{display:flex;align-items:center;flex-direction:column;}img{max-width:140px;}h4{font:20px/24px Fira Code;text-align:center;}p{font:10px/12px Fira Code;text-align:center;}"]);

/***/ })

})
//# sourceMappingURL=index.js.117c0968de4434bc578f.hot-update.js.map