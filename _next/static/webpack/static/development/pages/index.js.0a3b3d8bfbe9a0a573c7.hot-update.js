...
})(["width:100%;display:flex;align-items:center;overflow-x:auto;padding:20px;::-webkit-scrollbar-track{-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.3);border-radius:10px;background-color:#f5f5f5;height:5px;}::-webkit-scrollbar{width:12px;height:5px;background-color:#f5f5f5;}::-webkit-scrollbar-thumb{background-color:", ";border-radius:10px;height:4px;-webkit-box-shadow:inset 0 0 6px rgba(0,0,0,0.3);}"], function (_ref) {
...
//# sourceMappingURL=index.js.0a3b3d8bfbe9a0a573c7.hot-update.js.map